...
import com.example.paedsdeve.GSEDCSV.getclasses.GetHFacilities;
import com.example.paedsdeve.GSEDCSV.getclasses.GetLHWs;
import com.example.paedsdeve.GSEDCSV.getclasses.GetSources;
import com.example.paedsdeve.GSEDCSV.getclasses.GetTehsil;
import com.example.paedsdeve.GSEDCSV.getclasses.GetUCs;
import com.example.paedsdeve.GSEDCSV.getclasses.GetUsers;
import com.example.paedsdeve.GSEDCSV.getclasses.GetVillages;
import com.example.paedsdeve.GSEDCSV.syncclasses.SyncForms;
import com.example.paedsdeve.GSEDCSV.AndroidDatabaseManager;
import com.example.paedsdeve.GSEDCSV.AppMain;
import com.example.paedsdeve.GSEDCSV.DatabaseHelper;
import com.example.paedsdeve.GSEDCSV.FormsList;
import com.example.paedsdeve.cbt_child_recruitment.R;
import com.example.paedsdeve.GSEDCSV.contracts.FormsContract;
import com.example.paedsdeve.GSEDCSV.contracts.HFacilitiesContract;
import com.example.paedsdeve.GSEDCSV.contracts.LHWsContract;
import com.example.paedsdeve.GSEDCSV.contracts.TehsilsContract;
...
//        End Tag
        ...
        if (todaysForms.size() > 0) {
            ...
            String iStatus;
            rSumText += "--------------------------------------------------\r\n";
            rSumText += "[ CHILD_ID ] \t[Form Status] \t[Sync Status]----------\r\n";
            rSumText += "--------------------------------------------------\r\n";
